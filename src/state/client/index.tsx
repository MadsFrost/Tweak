...
interface SetTextPayload {
  ...
  export const client = createSlice({
    ...
    reducers: {
        setBackground: (state, action: PayloadAction<SetBackgroundPayload>) => {
            ...
            const rgbaColor = `rgba(${bgColor.r},${bgColor.g},${bgColor.b},${bgColor.a ?? 1})`
        ...
        setText: (state, action: PayloadAction<SetTextPayload>) => {
            ...
            const rgbaColor = `rgba(${textColor.r}, ${textColor.g}, ${textColor.b}, ${textColor.a ?? 1})`
            const element = action.payload.type;
  ...
  export const { setBackground, setText, togglePersonalSettings } = client.actions;
